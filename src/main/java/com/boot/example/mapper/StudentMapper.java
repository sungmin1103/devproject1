...
public interface StudentMapper {
    ...
    @Select("""
            SELECT st.no as no, sd_num, sd_name, sd_id, sd_birth, sd_phone, sd_address, sd_date, su.s_num as s_num, s_name
    ...
    @Insert("""
            INSERT INTO student(no, sd_num, sd_name, sd_id, sd_passwd, s_num, sd_birth, sd_phone, sd_address)
            VALUES(stu_seq.nextval, #{student.studentNumber}, #{student.studentName}, #{student.studentId},#{student.studentPasswd},
                   #{student.subject.subjectNumber}, #{student.studentBirth}, #{student.studentPhone}, #{student.studentAddress})
    """)
